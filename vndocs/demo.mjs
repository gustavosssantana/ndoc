...
const { POST: login } = await import('./api/auth/login.js');
const { GET: me } = await import('./api/auth/me.js');
const { POST: novaPasta, GET: pastas } = await import('./api/folders.js');
const { POST: novoTemplate } = await import('./api/templates.js');
const { POST: novaPlanilha } = await import('./api/sheets.js');
const { POST: inspecionar } = await import('./api/inspect.js');
const { POST: gerar } = await import('./api/generate.js');
const { GET: historico } = await import('./api/generations.js');
const { GET: painel } = await import('./api/dashboard.js');
const { GET: conta } = await import('./api/account.js');
