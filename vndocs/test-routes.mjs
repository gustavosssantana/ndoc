...
const { GET: getFolders, POST: postFolder } = await import('./api/folders.js');
const { GET: getTemplates, POST: postTemplate, DELETE: delTemplate } = await import('./api/templates.js');
const { GET: getSheets, POST: postSheet } = await import('./api/sheets.js');
const { GET: getGenerations } = await import('./api/generations.js');
const { GET: getDashboard } = await import('./api/dashboard.js');
const { GET: getUsage } = await import('./api/usage.js');
const { POST: postGenerate } = await import('./api/generate.js');
const { GET: getAccount, PATCH: patchAccount } = await import('./api/account.js');
const { POST: postRegister } = await import('./api/auth/register.js');
const { POST: postLogin } = await import('./api/auth/login.js');
const { POST: postLogout } = await import('./api/auth/logout.js');
const { GET: getMe } = await import('./api/auth/me.js');
const { POST: postInspect } = await import('./api/inspect.js');
