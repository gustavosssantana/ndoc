...
const STATUS_CONFIG = {
  completed: { label: 'Concluído',   bg: 'rgba(34,197,94,0.12)',   color: 'var(--verde)', dot: 'var(--verde)' },
  processing: { label: 'Gerando',    bg: 'rgba(202,138,4,0.12)',   color: 'var(--ambar)', dot: '#EAB308', pulse: true },
  failed:    { label: 'Falhou',      bg: 'rgba(220,38,38,0.10)',   color: 'var(--rubro)', dot: 'var(--rubro)' },
};
