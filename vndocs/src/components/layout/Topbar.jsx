...
export default function Topbar({ crumb, title, subtitle, actions }) {
  ...
  const { avisos, iniciais } = useAccount();
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 16, padding: "12px 28px", borderBottom: "1px solid rgba(15,23,42,.08)", flexShrink: 0, background: "#fff" }}>
