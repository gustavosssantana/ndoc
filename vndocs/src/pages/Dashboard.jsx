...
function StatCard({ Icon, label, value, sub, good }) {
  return (
    <div className="hoverable" style={{ background: 'var(--n0)', border: '1px solid var(--n3)', borderRadius: 16, padding: '20px 22px', flex: '1 1 200px', minWidth: 190, boxShadow: '0 1px 2px var(--n2)' }}>
