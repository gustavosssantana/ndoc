          ...
          <div style={{ position: 'relative', flexShrink: 0, borderRadius: 22, overflow: 'hidden', background: 'linear-gradient(120deg,#1D4ED8 0%,#2563EB 55%,#3B82F6 100%)', padding: '32px 36px', display: 'flex', flexWrap: 'wrap', gap: 32, color: '#fff' }}>
            ...
            <div style={{ flex: 1, minWidth: 320, position: 'relative', zIndex: 1 }}>
              ...
              <div style={{ display: 'flex', gap: 12 }}>
                ...
                <button onClick={() => navigate('/biblioteca')} style={{ display: 'flex', alignItems: 'center', gap: 9, height: 48, padding: '0 22px', borderRadius: 12, background: 'rgba(255,255,255,.12)', color: '#fff', border: '1px solid rgba(255,255,255,.3)', fontSize: 15, fontWeight: 600, cursor: 'pointer' }}
            ...
            {/* Plan summary */}
            <div style={{ width: 320, flexShrink: 0, position: 'relative', zIndex: 1, paddingLeft: 32, borderLeft: '1px solid rgba(255,255,255,.18)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              {ACTIVITY.map((a, i) => (
                <div key={a.id} className="row-hover" style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '14px 10px', borderTop: i === 0 ? 'none' : '1px solid rgba(15,23,42,.06)' }}>
                  ...
                  <button style={{ width: 32, height: 32, borderRadius: 8, background: 'none', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(15,23,42,.45)', cursor: 'pointer', flexShrink: 0 }}
