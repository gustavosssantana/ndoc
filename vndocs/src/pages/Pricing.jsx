    ...
    <AppLayout>
      <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
        ...
        <div className="stagger" style={{ flex: 1, overflowY: 'auto', padding: isMobile ? '18px 14px' : '28px 32px', display: 'flex', flexDirection: 'column', gap: 28 }}>
          ...
          {/* Buy credits */}
          <div style={{ background: 'linear-gradient(135deg,rgba(37,99,235,.10),rgba(37,99,235,.03)),#ffffff', border: '1px solid rgba(37,99,235,.25)', borderRadius: 14, padding: isMobile ? '16px 14px' : '24px 28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div>
