...
function PainelMarketing() {
  return (
    <div style={{
      flex: 1,
      background: 'radial-gradient(820px 620px at 68% 26%, rgba(37,99,235,.13), transparent 62%), var(--n2)',
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <div style={{
          fontFamily: "'Geist Mono', monospace", fontSize: 12, color: 'var(--azul)',
        ...
        <h2 style={{
          ...
          Transforme templates<br />em <span style={{ color: 'var(--azul)' }}>centenas</span> de docs.
        </h2>

        <p style={{
          fontSize: 15, color: 'var(--n7)', lineHeight: 1.6,
          ...
          {[
            ...
            <div key={v}>
              <div style={{
                ...
                letterSpacing: '-0.03em', color: 'var(--azul)',
              }}>{v}</div>
