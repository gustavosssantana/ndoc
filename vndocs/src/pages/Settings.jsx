...
import { reabrirTour } from '../components/ui/Tour';
...
function AbaEquipe({ isMobile }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 40, maxWidth: 620 }}>
      ...
      <Secao
        titulo="Tutorial"
        apoio="Rever a apresentação que destaca cada parte do sistema."
      >
        <div>
          <Acao tipo="quieta" largura={isMobile ? '100%' : undefined}
            aoClicar={() => { reabrirTour(); window.location.href = '/'; }}>
            Ver o tutorial de novo
          </Acao>
        </div>
      </Secao>
