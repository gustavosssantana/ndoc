...
export default function History() {
  ...
  const { data: lotes, loading, error: erroCarga } = useApi('/api/generations', []);
        ...
        <Topbar
          ...
          actions={
            <button className="h-ghost-btn">
              <RefreshCw size={13} strokeWidth={1.9} /> Atualizar
            </button>
          }
        />
                  ...
                  return (
                    <tr key={h.id} className={err ? 'is-err-row' : ''}>
                      ...
                      <td style={{ textAlign: 'right' }}>
                        {err ? (
                          <button className="h-act h-act-retry"><RefreshCw size={12} />Tentar de novo</button>
                        ) : (
                          <button className="h-act h-act-dl"><Download size={12} />Baixar</button>
                        )}
                      </td>
                    </tr>
                  );
