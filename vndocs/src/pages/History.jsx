...
.h-ledger td { padding: 13px 16px; border-bottom: 1px solid var(--n2); vertical-align: middle; }
...
.h-vol-track { width: 76px; height: 4px; border-radius: 999px; background: var(--n3); overflow: hidden; }
.h-vol-fill {
...
.h-pill.is-err { background: rgba(220,38,38,.10); color: var(--rubro); }
.h-dot { width: 6px; height: 6px; border-radius: 50%; background: var(--verde); }
...
.h-act-retry { background: var(--orange); border: 1px solid var(--orange); color: var(--n0); }
