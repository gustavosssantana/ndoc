    ...
    <AppLayout>
      <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, display: 'flex', overflow: 'hidden', position: 'relative' }}>
          {/* ─── Left: config ─── */}
          <div className="stagger" style={{ width: 460, borderRight: '1px solid rgba(15,23,42,.08)', overflowY: 'auto', padding: 22, display: 'flex', flexDirection: 'column', gap: 16, flexShrink: 0, background: '#f6f7f9' }}>
