...
const ROTAS = {
  ...
  'avatar':        () => import('../lib/routes/avatar.js'),
  'download':      () => import('../lib/routes/download.js'),
  'team':          () => import('../lib/routes/team.js'),
  'join':          () => import('../lib/routes/join.js'),
  /* As rotas de autenticação respondem em duas formas.
     A Vercel só entrega caminhos de UM nível para esta função, então
     /api/auth/login chega aqui como "auth-login" (o vercel.json reescreve).
     As chaves com barra ficam para quando a chamada vier direta. */
  ...
  'auth-password': () => import('../lib/routes/auth-password.js'),
  'auth-sessions': () => import('../lib/routes/auth-sessions.js'),
  'auth/sessions': () => import('../lib/routes/auth-sessions.js'),
  'auth/password': () => import('../lib/routes/auth-password.js'),
  'auth/register': () => import('../lib/routes/auth-register.js'),
  'auth/login':    () => import('../lib/routes/auth-login.js'),
